...
def calcWeight(marker_article_map, disease, marker, article_citation_map):
...
def makeGraph(marker_article_map, marker_type_map, article_citation_map):
...
def main(argv):
	...
	print 'len(marker_article_map): ', len(marker_article_map)
	print 'len(marker_type_map): ', len(marker_type_map)
	print 'len(article_citation_map): ', len(article_citation_map)

	markerGraph = makeGraph(marker_article_map, marker_type_map, article_citation_map)
